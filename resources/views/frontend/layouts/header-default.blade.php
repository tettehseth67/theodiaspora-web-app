                    ...
                    <div class="basic-container clearfix">
                        <div class="navbar-inner">
                            ...
                            <ul class="nav navbar-items pull-left">
                                <li class="list-item">
                                    <a href="/" class="logo-general"><img src="images/logo-dark.png" class="img-fluid" width="166" height="50" alt="Logo" /></a>
                                    <a href="/" class="logo-sticky"><img src="images/logo-dark.png" class="img-fluid" width="166" height="50" alt="Logo" /></a>
                                </li>
                            </ul>
                            <!-- Menu -->
