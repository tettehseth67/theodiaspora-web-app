                        ...
                        <div class="col-11 col-md-10 col-lg-9 col-xl-8 mx-auto">
                            ...
                            <form id="loginForm" method="post" action="{{ route('login') }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="email" class="form-control bg-light border-light"
                                        id="emailAddress" required="" name="email" placeholder="Enter Your Email">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col text-end"><a class="text-2 fw-300"
                                            href="forgot-password-9.html">Forgot Password ?</a></div>
                                </div>
                            ...
                            <div class="row gx-3">
                                <div class="col-6 d-grid">
                                    <button type="button"
                                        class="btn btn-light btn-sm fw-400 shadow-none border"><span
