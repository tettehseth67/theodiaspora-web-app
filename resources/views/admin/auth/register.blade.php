                    ...
                    <div class="row gx-0">
                        <div class="col-11 col-md-10 mx-auto">
                            <p class="text-end text-2 text-muted fw-300">Already a member? <a class="fw-300"
                                    href="{{ route('admin.login') }}">Sign in now</a></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-11 col-md-10 col-lg-9 col-xl-8 mx-auto">
                            ...
                            <form id="registerForm" method="post" action="{{ route('admin.register') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light border-light" id="fullName" name="name"
                                        required="" placeholder="Enter Your Name">
                                </div>
                                <div class="mb-3">
                                    <label for="emailAddress" class="form-label fw-300">Email Address</label>
                                    <input type="email" class="form-control bg-light border-light" id="emailAddress" name="email"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control bg-light border-light"
                                        id="loginPassword" name="password" required="" placeholder="Enter Password">
                                </div>
